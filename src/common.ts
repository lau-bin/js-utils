...
export function merge(source: object, dest: object, comparator?: (source_p: unknown, dest_p: unknown) => MergeOptions, transformer?: (dest_p: unknown) => unknown) {
...
export function copyStructure(src: object, copy: object) {
...
export function packObject(serializable: SerializableObject) {
